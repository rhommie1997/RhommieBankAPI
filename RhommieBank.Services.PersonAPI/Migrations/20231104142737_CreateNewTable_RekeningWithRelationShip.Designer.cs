...
namespace RhommieBank.Services.PersonAPI.Migrations
{
    ...
    [Migration("20231104142737_CreateNewTable_RekeningWithRelationShip")]
    partial class CreateNewTable_RekeningWithRelationShip
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("RhommieBank.Services.PersonAPI.Models.Person", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            age = 22,
                            created_by = "System",
                            created_dt = new DateTime(2023, 11, 4, 21, 27, 37, 178, DateTimeKind.Local).AddTicks(6542),
                            name = "Erling Haaland"
                        },
                        new
                        {
                            ...
                            age = 24,
                            created_by = "System",
                            created_dt = new DateTime(2023, 11, 4, 21, 27, 37, 178, DateTimeKind.Local).AddTicks(6589),
                            name = "Kylian Mbappe"
                        });
                });
            ...
            modelBuilder.Entity("RhommieBank.Services.PersonAPI.Models.Rekening", b =>
                {
                    ...
                    b.Property<string>("created_dt")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("isAccres")
                        .HasColumnType("bit");
